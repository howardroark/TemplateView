(function(root, factory) {
  ...
  if (typeof define === 'function' && define.amd) {
    define(['backbone', 'underscore', 'nunjucks', 'morphdom', 'jquery'], function(Backbone, _, nunjucks, morphdom, $) {
      return (root.TemplateView = factory(root, Backbone, _, nunjucks, morphdom, $));
    });
    ...
    var $ = require('jquery');
    module.exports = factory(root, Backbone, _, nunjucks, morphdom, $);
  } else {
    root.TemplateView = factory(root, root.Backbone, root._, root.nunjucks, root.morphdom, root.jQuery);
  }

}(this, function(root, Backbone, _, nunjucks, morphdom, $) {
